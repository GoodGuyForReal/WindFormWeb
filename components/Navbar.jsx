    ...
    <div>
      <header className="fixed inset-x-0 top-0 z-50 border-b border-gray-200 bg-white/50 backdrop-blur-lg">
        ...
        >
          ...
          <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white/50 px-6 py-6 backdrop-blur-lg sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
