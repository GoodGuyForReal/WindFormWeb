...
function Card({ setisOpen }: any) {
  return (
    <div
      ...
      className="relative cursor-pointer rounded-xl border border-gray-500 bg-gray-50 px-6 py-2.5 shadow-md duration-200 hover:shadow-xl hover:shadow-gray-400/50 sm:px-3.5"
    >
  ...
  return (
    <div className="relative flex w-full justify-center">
      <button
        ...
        className="rounded-md bg-gray-500 px-4 py-2 text-sm text-slate-50 duration-200 hover:bg-gray-500/80"
      >
        Toast Info
      </button>
      {isOpen && (
