    ...
    <div className="w-full">
      ...
      <div className="flex gap-2">
        <input
          ...
          className="block w-full rounded-md border-0 py-2.5 pl-4 pr-[88px] text-gray-900 outline-none ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-500 sm:text-sm sm:leading-6"
          placeholder="Search..."
        />
