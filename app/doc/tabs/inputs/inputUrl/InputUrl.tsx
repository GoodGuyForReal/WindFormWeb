    ...
    <div className="w-full max-w-sm">
      ...
      <div className="flex">
        ...
        <input
          ...
          name="url"
          id="url"
          className="block w-full rounded-r-md border border-gray-300 py-2 pl-4 pr-4 text-gray-900 outline-none ring-inset placeholder:text-gray-400 focus:ring-2 focus:ring-blue-500 sm:text-sm sm:leading-6"
