    ...
    <div className="w-full max-w-sm">
      ...
      <div>
        <input
          ...
          name="Email"
          id="errorEmail"
          className="block w-full rounded-md border-0 px-4 py-2 text-green-900 outline-none ring-1 ring-inset ring-green-500 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-500 sm:text-sm sm:leading-6"
