...
const page = () => {
    ...
    return (
        <div className="w-full h-full pt-12 flex-1 items-start md:grid md:grid-cols-[200px_minmax(0,1fr)_200px] md:gap-6 lg:grid-cols-[250px_minmax(0,1fr)_200px] lg:gap-10 bg-gray-500">
